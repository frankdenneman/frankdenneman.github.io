...
Over the last 20 years, we designed our core data center platform following the CPU roadmap. But in today's world, the devices attached to the processor make radical and revolutionary improvements, catering to the needs of the new workloads. I'm talking about devices like the GPU, the network adapter, and its natural offspring, the data processing unit (DPU). In the article "[Project Monterey and the need for network cycles offload for ML workloads](https://frankdenneman.ai/2021/10/06/project-monterey-and-the-need-for-network-cycles-offload-for-ml-workloads/)" I zoom into what's in store for us data center architects in the upcoming years.

[![](images/ML-Infrastructure.svg)](/wp-content-mirror/2021/08/ML-Infrastructure.svg)
