...
[![03-05-Broadwell_HCC_Architecture](images/03-05-Broadwell_HCC_Architecture.svg)](/wp-content-mirror/2016/07/03-05-Broadwell_HCC_Architecture.svg)
...
[![04-02-Snoop_mode_characteristics](images/04-02-Snoop_mode_characteristics-750x396.png)](/wp-content-mirror/2016/07/04-02-Snoop_mode_characteristics.png) If you have your workload correctly sized and are able to fit workloads within NUMA nodes, Cluster-on-Die can improve performance. If the virtual data center is designed to run a high consolidation ratio, forcing the ESXi CPU scheduler to span small footprint VMs across NUMA nodes, Home Snoop with Directory and OSB might be a better fit.
