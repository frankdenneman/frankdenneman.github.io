...
Part 1: [Memory Deep Dive Intro](https://frankdenneman.ai/2015/02/18/memory-configuration-scalability-blog-series/ "Memory configuration scalability blog series") Part 2: [Memory subsystem Organisation](https://frankdenneman.ai/2015/02/18/memory-tech-primer-memory-subsystem-organization/ "Memory deep dive: Memory subsystem organisation") Part 3: [Memory Subsystem Bandwidth](https://frankdenneman.ai/2015/02/19/memory-deep-dive-memory-subsystem-bandwidth/ "Memory Deep Dive: Memory Subsystem Bandwidth") Part 4: [Optimizing for Performance](https://frankdenneman.ai/2015/02/20/memory-deep-dive/ "Memory Deep Dive - Optimizing for Performance") Part 5: [DDR4 Memory](https://frankdenneman.ai/2015/02/25/memory-deep-dive-ddr4/ "Memory Deep Dive - DDR4 Memory") Part 6: [NUMA Architecture and Data Locality](https://frankdenneman.ai/2015/02/27/memory-deep-dive-numa-data-locality/ "Memory Deep Dive: NUMA and Data Locality") Part 7: [Memory Deep Dive Summary](https://frankdenneman.ai/2015/03/02/memory-deep-dive-summary/) **Memory Subsystem Bandwidth** Unfortunately, there is a downside when aiming for high memory capacity configurations and that is the loss of bandwidth. As shown in Table 1, using more physical ranks per channel lowers the clock frequency of the memory banks. As more ranks per DIMM are used the electrical loading of the memory module increases. And as more ranks are used in a memory channel, memory speed drops restricting the use of additional memory. Therefore in certain configurations, DIMMs will run slower than their listed maximum speeds.
...
\[caption id="attachment\_4986" align="aligncenter" width="680"\][![DDR signal rate per clock cycle](images/03-DDR-signal-rate-per-clock-cycle-680x285.png)](/wp-content-mirror/2015/02/03-DDR-signal-rate-per-clock-cycle.png) DDR signal rate per clock cycle\[/caption\]
...
Up next, part 4: [Optimizing for Performance](https://frankdenneman.ai/2015/02/20/memory-deep-dive/ "Memory Deep Dive - Optimizing for Performance") The memory deep dive series: Part 1: [Memory Deep Dive Intro](https://frankdenneman.ai/2015/02/18/memory-configuration-scalability-blog-series/ "Memory configuration scalability blog series") Part 2: [Memory subsystem Organisation](https://frankdenneman.ai/2015/02/18/memory-tech-primer-memory-subsystem-organization/ "Memory deep dive: Memory subsystem organisation") Part 3: [Memory Subsystem Bandwidth](https://frankdenneman.ai/2015/02/19/memory-deep-dive-memory-subsystem-bandwidth/ "Memory Deep Dive: Memory Subsystem Bandwidth") Part 4: [Optimizing for Performance](https://frankdenneman.ai/2015/02/20/memory-deep-dive/ "Memory Deep Dive - Optimizing for Performance") Part 5: [DDR4 Memory](https://frankdenneman.ai/2015/02/25/memory-deep-dive-ddr4/ "Memory Deep Dive - DDR4 Memory") Part 6: [NUMA Architecture and Data Locality](https://frankdenneman.ai/2015/02/27/memory-deep-dive-numa-data-locality/ "Memory Deep Dive: NUMA and Data Locality") Part 7: [Memory Deep Dive Summary](https://frankdenneman.ai/2015/03/02/memory-deep-dive-summary/)
