...
[Project Pacific](https://frankdenneman.ai/2019/08/26/5-things-to-know-about-project-pacific/) transforms vSphere into a unified application platform. This new platform runs both virtual machine and Linux containers as native workload constructs. Just introducing Linux containers as a new workload object is not enough. To manage containers properly, you need a legitimate orchestrator. And on top of that, you need to make sure that existing services, such as DRS, can handle the different lifecycles of these different objects. Containers typically have a shorter lifecycle than virtual machines, where VMs "live" for years, containers have a shorter life expectancy. And this massively different churn impacts initial placement and load-balancing operations of resource management services.
...
[![](images/ContainerRuntimeforESXi-1.png)](https://frankdenneman.ai/wp-content/uploads/2020/03/ContainerRuntimeforESXi-1.png)
...
[![](images/DRS-Pacific-Integration-vSphere-Pod-1024x775.png)](https://frankdenneman.ai/wp-content/uploads/2020/03/DRS-Pacific-Integration-vSphere-Pod.png)
