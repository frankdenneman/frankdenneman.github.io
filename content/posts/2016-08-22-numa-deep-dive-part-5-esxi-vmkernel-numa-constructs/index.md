...
Within the CPU package, cores exist. In this example, the CPU package contains four cores and each core has hyper-threading (HT) enabled. All cores (and thus HT) share the same [cache architecture](/2016-07-11-numa-deep-dive-part-3-cache-coherency/).
...
Typically a CPU Package and its local memory are synonymous with a NUMA home node, exceptions are Intel Cluster-on-Die technology and AMD Opteron ([Magny Cours](/2011-01-05-amd-magny-cours-and-esx/) and newer). When [Cluster-on-Die](/2016-07-11-numa-deep-dive-part-3-cache-coherency/) is enabled on an Intel Xeon CPU, the CPU package is split up into two NUMA nodes optimizing the local cache structures.
...
The 2016 NUMA Deep Dive Series: Part 0: [Introduction NUMA Deep Dive Series](/2016-07-06-introduction-2016-numa-deep-dive-series/) Part 1: [From UMA to NUMA](/2016-07-07-numa-deep-dive-part-1-uma-numa/) Part 2: [System Architecture](/2016-07-08-numa-deep-dive-part-2-system-architecture/) Part 3: [Cache Coherency](/2016-07-11-numa-deep-dive-part-3-cache-coherency/) Part 4: [Local Memory Optimization](/2016-07-13-numa-deep-dive-4-local-memory-optimization/) Part 5: [ESXi VMkernel NUMA Constructs](/2016-08-22-numa-deep-dive-part-5-esxi-vmkernel-numa-constructs/) Part 6: NUMA Initial Placement and Load Balancing Operations Part 7: From NUMA to UMA
