...
_Please note that a vSphere pod will not be migrated. Although DRS does not load-balance vSphere pods to get a better overall capacity usage, it will keep track of the vSphere Pods demand since it could affect the performance of other workloads (VMs and pods) running on the host._ For more info about vSphere pods, please read the article "[Initial Placement of a vSphere Pod](/2020-03-06-initial-placement-of-a-vsphere-native-pod/)".
